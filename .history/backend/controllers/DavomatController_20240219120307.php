...
class DavomatController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $post = Yii::$app->request->get();
         if ($post) { 
            $searchModel->date_start = $post->date_start; // Başlangıç tarihi
            $searchModel->date_end = $post->date_end;          
            echo '<pre>';
                var_dump($searchModel->date_start);die();
            echo '</pre>';
        }
         
       $searchModel->date_start = '2023-08-01'; // Başlangıç tarihi
       $searchModel->date_end = '2023-09-29';    
